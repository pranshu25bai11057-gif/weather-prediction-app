...
def data_get():
    city = city_name.get()
    data = requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=e94fdf4d61042e80d4184dae7cea4c2e").json()
...
name_label = Label(win,text="Pranshu's Weather App",font = ("Times New Roman",40,"bold"))
...
com = ttk.Combobox(win,text="Pranshu's Weather App",values=list_name,font = ("Times New Roman",20,"bold"),textvariable=city_name)
